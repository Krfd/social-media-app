    ...
    return (
        <div className="px-4 py-12 max-w-2xl mx-auto">
            ...
            <p className="mb-4 text-slate-700">
                ...
                (MongoDB, Express, React, Note.js) stack. It includes
                authentication features that allow users to signup, login, and
                lagout, and provides access to protected routes only for
                authenticated users.
            </p>
            <p className="mb-4 text-slate-700">
                ...
                Authenticaiton is implemented using JSON Web Token (JWT).
            </p>
            <p className="mb-4 text-slate-700">
                This application is intended as a starting point for building
                full-stack web applications with authentication using MERN
